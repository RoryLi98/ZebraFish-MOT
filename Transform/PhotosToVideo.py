...
WSI_MASK_PATH = 'D:\\bishe\\3DZeF20\\3DZeF20\\train\\ZebraFish-03\\MatplotlibTracklet\\T\\'
...
out = cv2.VideoWriter("ZebraFish-03-T-Head-Tracklet.avi", fourcc, 60.0, (700, 700))
# out = cv2.VideoWriter("ZebraFish-03-X-Head-Tracklet.avi", fourcc, 60.0, (721, 724))
for path in paths:
