...
WSI_MASK_PATH = 'D:\\bishe\\3DZeF20\\3DZeF20\\train\\ZebraFish-03\\MatplotlibTracklet\\X\\'
...
# out = cv2.VideoWriter("ZebraFish-03-F-Tracklet.avi", fourcc, 60.0, (700, 700))
out = cv2.VideoWriter("ZebraFish-03-X-Tracklet.avi", fourcc, 60.0, (721, 724))
for path in paths:
