...
def test(args):
    ...
    # output_df = pd.DataFrame(columns=["Filename", "Object ID", "Annotation tag", "UpperLeftCornerX", "UpperLeftCornerY", "LowerRightCornerX", "LowerRightCornerY", "Confidence"])
    ...
    for filename in filenames:
        ...
        #                 "UpperLeftCornerX": list(bboxes[:,0]),
        #                 "UpperLeftCornerY": list(bboxes[:,1]),
        #                 "LowerRightCornerX": list(bboxes[:,2]),
        #                 "LowerRightCornerY": list(bboxes[:,3]),
